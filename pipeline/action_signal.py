...
# 将 assess_risk tool 返回的结构化 risk_level 映射到标准 ActionType。
...
CONFIDENCE_BASE: Dict[str, float] = {
    ...
    # ---- 降级 fallback（无 tool_results，仅正则提取）-------
    "fallback": 0.45,
}
